...
<BODY BGCOLOR="#FFFFFF" LINK="#FF0000" VLINK="#820594" ALINK="#111111" BACKGROUND="wm5b.gif">
...
<P><TT><A HREF="train-images-idx3-ubyte.gz">train-images-idx3-ubyte.gz</A>:&nbsp;
...
<tr><td colspan="4" align="center"><b>Linear Classifiers</b></td></tr>
...
<tr><td colspan="4" align="center"><b>K-Nearest Neighbors</b></td></tr>
...
<tr><td colspan="4" align="center"><b>Boosted Stumps</b></td></tr>
...
<tr><td colspan="4" align="center"><b>Non-Linear Classifiers</b></td></tr>
...
<tr><td colspan="4" align="center"><b>SVMs</b></td></tr>
...
<tr><td colspan="4" align="center"><b>Neural Nets</b></td></tr>
...
<tr><td colspan="4" align="center"><b>Convolutional nets</b></td></tr>
...
<H3><FONT COLOR="#3333FF">References</FONT></H3>

<DL>

<DT><A NAME="lecun-98">[LeCun et al., 1998a]</A><DD>Y. LeCun, L. Bottou,
...
<P>There are 4 files:<TT></TT>

<P><TT>train-images-idx3-ubyte: training set images</TT>
...
<P>The training set contains 60000 examples, and the test set 10000 examples.

<P>The first 5000 examples of the test set are taken from the original
...
<P>The magic number is an integer (MSB first). The first 2 bytes are always
0.

<P>The third byte codes the type of the data:
...
<P>The 4-th byte codes the number of dimensions of the vector/matrix: 1
for vectors, 2 for matrices....

<P>The sizes in each dimension are 4-byte integers (MSB first, high endian,
like in most non-Intel processors).

<P>The data is stored like in a C array, i.e. the index in the last dimension
changes the fastest.
<BR>&nbsp;
<BR>&nbsp;
<BR>
...
<p>
<font COLOR="#3333FF"><a
href="http://homepage.mac.com/corinnacortes/">Corinna Cortes</a>, Research Scientist<br>
